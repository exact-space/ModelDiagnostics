...
modelInputTags = inputTags + [eqpStatusTag]

#replace with desired start and endtimes
df_inputs = getValuesV2(modelInputTags, "startTime", "endTime")

#filter the df_inputs where the value of column having name eqpStatusTag is 1
...
reportData.run(reference_data= refDataFrame, current_data= currentDataFrame)
